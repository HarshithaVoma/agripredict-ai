...
def load_models():
    ...
    global price_crop_crop_enc  # ✅ FIXED
    global meta
    ...
    try:
        ...
        print("⚠️ Crop-specific price models not found:", e)
    ...
    try:
        ...
        print("⚠️ Global price model not found:", e)
...
def predict_price():
    ...
    use_specific = (
        matched_crop is not None and   # ✅ FIXED
